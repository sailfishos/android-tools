...
# - split_bootimg
# - mkbootimg
%define obsolete_android_tools_hadk_ver 5.1.1+git9
...
Patch0001:      0002-Move-static-libraries-to-separate-cmakelists-files-a.patch
Patch0002:      0003-Disable-unwanted-programs.patch
Patch0003:      0004-Make-it-possible-to-disable-COMPLETIONS.patch
...
# Conflict with android-tools-hadk up to %{obsolete_android_tools_hadk_ver} because it
# used to include fastboot
Conflicts:      android-tools-hadk <= %{obsolete_android_tools_hadk_ver}
